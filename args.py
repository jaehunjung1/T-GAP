...
def get_args():
    ...
    args.add_argument('--interpret', action='store_true', help="Interpret mode.")
    ...
    args.add_argument('--weight_decay', default=1e-3, type=float, help="Node embedding weight decay ratio.")

    args.add_argument('--node_dim', default=100, type=int, help="Node embedding size.")
    args.add_argument('--gamma', default=0.5, type=float, help="Gamma for diachronic node embedding.")
    ...
    args.add_argument('--dropout', default=0, type=float, help="Dropout ratio.")
